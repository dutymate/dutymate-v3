...
const Game = () => {
  ...
  return (
    <>
      <SEO title="게임 | Dutymate" description="듀티메이트의 미니게임을 체험해보세요!" />
        ...
        <div className="flex-1 min-w-0 px-4 lg:px-8 py-6 overflow-y-auto">
          ...
          <div className="flex items-center gap-3 lg:hidden mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-500">듀티메이트의 미니게임을 체험해보세요!</p>
            </div>
            {isDemo && <DemoTimer />}
          </div>
          ...
          <div className="hidden lg:block">
            <Title title="DutyWorm Game" subtitle="듀티메이트의 미니게임을 체험해보세요!" />
          </div>
          ...
          <div className="mt-8 flex flex-col items-center justify-center">
            <div className="max-w-md w-full bg-white rounded-xl p-6 shadow-md">
              ...
              <p className="text-gray-600 mb-6">
                방향키를 사용하여 지렁이를 조작하고, 듀티 뱃지를 먹어 점수를 획득하세요! 벽이나
                자신의 몸에 부딪히지 않도록 주의하세요.
              </p>
          ...
          <WormGameModal isOpen={isGameOpen} onClose={() => setIsGameOpen(false)} />
        </div>
      </div>
    </>
  );
