        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="pl-10">
            ...
            <div className="mb-3 flex items-center gap-4">
              <button
                onClick={() => navigate(`/admin/wards?page=${pageParam}`)}
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-800">병동 스케줄 관리</h1>
                <p className="text-sm text-gray-500 mt-0.3">관리자 전용 - 병동 ID: {wardId}</p>
              </div>
            </div>
          </div>

          {/* 스케줄 테이블 - 읽기 전용 */}
          <div className="flex flex-col gap-2.5 pb-8 scale-[0.93] origin-top">
